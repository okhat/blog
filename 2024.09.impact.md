...
**Milestone 3: Build the case for why the obvious alternative fails, and be patient.**

**Milestone 4: Understand that there are categories of users, and leverage that to grow.**

**Milestone 5: Turn interest into a growing community!**

**Milestone 6: Turn interest into active, collaborative, and modular downstream projects.**
